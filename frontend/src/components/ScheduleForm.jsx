...
const samplePayload = {
  ...
  employees: [
    ...
    { id: "e3", name: "Peter", role: "Operator", start_day: 2, first_shift: "A2", is_cover: false },
    { id: "e4", name: "Galia", role: "Operator", start_day: 3, first_shift: "A3", is_cover: false },
    { id: "e5", name: "Nelly", role: "Operator", start_day: 4, first_shift: "A2", is_cover: false },
    { id: "e6", name: "Reserve", role: "Cover", is_cover: true },
  ],
};
